...
function App() {
  ...
  async function newContract() {
    ...
    if (arbiter.length < 42) return toast.error('arbiter address is invalid')
    if (beneficiary === "") return toast.error('beneficiary was not provided')
    if (beneficiary.length < 42) return toast.error('beneficiary address is invalid')

    if (document.getElementById('wei').value === "") return toast.error('value was not provided')
